...
while True:
    ...
    if state == STATE_TOUCH:
        # start running the grasp subfunction using graspType, boxLocation, locationHoldTime as inputs
        # go to STATE_READY_DISPENSE and turn on reward LED if success, STATE_DISPENSE if failure
